...
#Define the derived class Player class Player:
def play(self):print("The player is playing cricket.")

#Define the derived class Batman class Batman (PLayer):
 def play(self):print("The batsman is bating.")

#Define the derived class Bowler as Blower (Player):
 def play(self):print("The bolower is bowling.")

#Create objects  Bating Bowler classes
batsman = Batsman()
bowler = Bowler()
